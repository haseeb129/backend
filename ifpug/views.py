...
def ifpug(request):
    ...
    newData={
        ...
        "FP Internal Logical Files %":(ilf_summary_count[0]+ilf_summary_count[1]+ilf_summary_count[2])/unadjustedFP,
        "FP External Interface Files %":(eif_summary_count[0]+eif_summary_count[1]+eif_summary_count[2])/unadjustedFP,
        "FP External Inputs %":(ei_summary_count[0]+ei_summary_count[1]+ei_summary_count[2])/unadjustedFP,
        "FP External Outputs %":(eo_summary_count[0]+eo_summary_count[1]+eo_summary_count[2])/unadjustedFP,
        "FP External Queries %":(eq_summary_count[0]+eq_summary_count[1]+eq_summary_count[2])/unadjustedFP,
